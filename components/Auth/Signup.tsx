          ...
          >
            ...
            {status === "authenticated" ? "" : <><div className="mb-10 flex items-center justify-center">
              ...
              <span className="dark:bg-stroke-dark hidden h-[1px] w-full max-w-[200px] bg-stroke dark:bg-strokedark sm:block"></span>
                ...
                <div className="flex flex-wrap gap-10 md:justify-center items-center xl:gap-15">

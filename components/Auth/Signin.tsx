...
const Signin = () => {
  ...
  const signin = async (e: any) => {
    ...
    e.preventDefault();
    try {
      let resp = await axios.post(`${apiUrl}/user/signin`, data);
      ...
      if (userData.status === "userExists") {
        ...
        if (rememberMe) {
          ...
          sessionStorage.setItem('userToken', userData.token); // Session-based
        }

        // Dispatch custom event to trigger header re-render

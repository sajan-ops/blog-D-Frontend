...
const Posts: React.FC = () => {
    ...
    const [categoryar, setCategoryar] = useState<any>([]);
    const [statusar, setStatusar] = useState<any>([]);
    const [authorar, setAuthorar] = useState<any>([]);
    const [datear, setDatear] = useState<any>([]);

    // Function to fetch posts from the backend
    const fetchPosts = async (filter: any, filterType: any) => {
        try {

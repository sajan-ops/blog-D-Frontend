...
export default function CreatePost() {
    ...
    const [editorState, setEditorState] = useState<EditorState>(
        ...
        [key: string]: number; // keys are words, values are densities
    }
    ...
    const [keywordDensity, setKeywordDensity] = useState<KeywordDensity>({}); // To hold keyword density results
        ...
        <div className="mx-auto rounded-lg bg-gray-100 p-10 pt-25 shadow-lg">
            ...
            >
                ...
                <div className="bg-white shadow-md rounded-lg p-4">
                    <h3 className="text-lg font-semibold text-gray-800 mb-2">Keyword Density:</h3>
                    <ul className="space-y-1">
                        {Object.entries(keywordDensity).map(([word, density]) => (
                            <li key={word} className="flex justify-between p-2 bg-gray-100 rounded-md">
                                <span className="text-gray-700">{word}</span>
                                <span className={`text-gray-600 ${density > 2 ? 'text-red-600' : ''}`}>
                                    {density}%
                                </span>
                            </li>
                        ))}
                    ...
                    {Object.values(keywordDensity).some(density => density > 2) && (
                        <p className="text-red-600 mt-2">
                            {Object.entries(keywordDensity).some(([, density]) => density > 2) ? "Too Much" : "Good"}
                        </p>
                    )}
                </div>
                ...
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    <div className="relative bg-white rounded-xl w-full max-w-2xl mx-4 my-6 shadow-2xl flex flex-col max-h-[90vh]">
                        ...
                        <div className="flex items-center justify-between p-6 border-b">
                            <h2 className="text-2xl font-bold text-gray-800">Preview Your Post</h2>
                            <button
                                onClick={() => setShowPreviewModal(false)}
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-6">
                            ...
                            <div className="p-4 border border-gray-200 rounded-lg space-y-3">
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span className="text-xs text-gray-600 font-medium">Google Search Result</span>
                                </div>

                                <div className="text-sm text-emerald-700">
                                    www.yourdomain.com › blog › {title.toLowerCase().replace(/\s+/g, '-')}
                                </div>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-2">
                                        <div className="w-4 h-4 bg-gray-200 rounded-full"></div>
                                        <span className="text-xs text-gray-600 font-medium">Social Media Card</span>
                                    </div>
                                    <button
                                        className="text-xs text-blue-600 hover:text-blue-700"
                                        onClick={() => {/* Toggle media selection */ }}
                                    >
                                        Change Image
                                    </button>
                                </div>
                                ...
                                <div className="border rounded-lg overflow-hidden bg-white shadow-sm">
                                    ...
                                    <div className="p-4">
                                        <div className="flex items-center space-x-2 mb-2">
                                            ...
                                            <span className="text-xs text-gray-600">yourdomain.com</span>
                                        </div>

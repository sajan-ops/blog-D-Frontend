...
const EditPostPage = () => {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    if (post.filePath && globalState.mediaItems.length === 0) {
                        const mediaItems = JSON.parse(post.filePath).map((path: string, index: number) => ({
    ...
    const handleRemoveMedia = (id: any) => {
        setglobalState({
            ...globalState,
            mediaItems: globalState.mediaItems.filter((val: any) => val.id !== id)
        });
    };
    ...
    return (
        <div className="p-10 mx-auto bg-gray-100 rounded-lg shadow-lg pt-25">
            ...
            >
                ...
                {globalState && globalState.mediaItems && globalState.mediaItems.length > 0 ? (
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 mt-5">
                        {globalState.mediaItems.map((mediaUrl: any, index: any) => (
                    ...
                    <p className="text-gray-500 text-center mt-5">No media selected. Please select from the gallery.</p>
                )}
                ...
                {mounted && (
                    <div className="md:col-span-2">
                        ...
                        <Editor
                            ...
                            editorStyle={{ height: 300, borderRadius: 0, border: "1px solid black" }}
                            toolbar={{
                                options: [
                                    "inline",
                                    "blockType",
